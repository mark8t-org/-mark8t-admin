...
<div id="saved-changes" class="top-app-bar-container">
	<Banner bind:open bind:centered bind:mobileStacked on:SMUIBanner:closed={handleBannerClosed}>
...
<AdminDrawer>
	...
	{#if override}
		<section class="">
			<Paper elevation={0} style="min-height:calc(100vh - 65px);">
				<Accordion>
					<slot {unsavedChanges} />
				</Accordion>
			</Paper>
								...
								>
									...
									<Actions>
										<ActionButtons>
											...
											>
												<Label>{layout === layoutSelected ? 'Selected' : 'Select'}</Label>
											</Button>
										</ActionButtons>
										<ActionIcons>
											<IconButton
