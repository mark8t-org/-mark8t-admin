...
<Accordion>
	...
	<p>
		<small
			>This page allows you to manage and configure the different services. <br /> You can create or
			edit API keys for services like Google Maps, and other API keys.
			<br /> <br />
			You can also access a Google Calendar directly from the app to schedule and manage events. Plus,
			you can use your Google Tag ID to track and analyze user behavior on the app using Google Analytics.
		</small>
	</p>
	<hr />
	<Panel
